...
class FormMenuPausa(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,imagen_background,color_border,active):
        ...
        self.text1 = Button(master=self,x=100,y=50,w=100,h=50,color_background=None,color_border=None,image_background=RUTA_IMAGEN + r"Menu\Button\Table.png",text="PAUSA",font="IMPACT",font_size=30,font_color=WHITE,on_click=None,on_click_param=None)
