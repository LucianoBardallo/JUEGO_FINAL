...
class FormMenuA(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,imagen_background,color_border,active):
        ...
        self.text1 = Button(master=self,x=ANCHO_VENTANA//2-200,y=100,w=400,h=100,color_background=None,color_border=None,image_background=RUTA_IMAGEN + r"Menu\Button\Table.png",text="SPACE ADVENTURE",font="IMPACT",font_size=40,font_color=WHITE,on_click=None,on_click_param=None)
