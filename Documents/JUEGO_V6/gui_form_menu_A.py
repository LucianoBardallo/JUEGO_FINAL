...
class FormMenuA(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,imagen_background,color_border,active):
        ...
        self.boton3 = Button(master=self,x=ANCHO_VENTANA//2-100,y=380,w=200,h=50,color_background=None,color_border=None,image_background=RUTA_IMAGEN + r"Menu\Button\Table.png",on_click=self.on_click_boton2,on_click_param=None,text="SALIR",font="IMPACT",font_size=30,font_color=WHITE)
